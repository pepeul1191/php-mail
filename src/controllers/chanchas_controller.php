...
class CanchasController extends \Configs\Controller
{
  ...
  public function createPassword($request, $response, $args) {
    ...
    try {
      ...
      //var_dump($data);exit();
      //mail builder
	  $content = require __DIR__ . '/../contents/canchas_create_password_content.php';
      $layout = require __DIR__ . '/../templates/canchas/layout_mail.php';
      $partial = require __DIR__ . '/../templates/canchas/partial_create_password.php';
      $lang = $data->{'lang'};
      //str_replace yiled
      $data_partial = array(
        '%demo' => $content[$lang]['demo'],
  ...
  public function wellcomeChangePasswordDemo($request, $response, $args) {
    $rpta = '';
    $status = 200;
    try {
      //post data
      ...
      $data->user = 'pepe';
	  $data->user_id = 1;
	  $data->activation_key = 'akldjfakldjfakldjfalkjdflkajdlfa';
	  $data->lang = 'sp';
	  $data->to = 'pepe.valdivia.caballero@gmail.com';
